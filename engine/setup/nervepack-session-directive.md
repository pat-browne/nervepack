...
This table covers high-frequency engine skills only — do NOT edit this file to add
overlay-specific triggers. Overlay skills (personal, team) are discovered automatically
from their descriptions; write a precise description and sessions will reach for them.
For anything not covered by the table, check the full nervepack skill index
