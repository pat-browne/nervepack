...
# (2026-07-13, np-llm.sh; carried into np_model.py in phase 9, closing a gap the
# original Slice-4 port missed): a stale CLAUDE_CODE_SESSION_ID inherited by the
# parent process must not reach the child, for BOTH drivers.
#
